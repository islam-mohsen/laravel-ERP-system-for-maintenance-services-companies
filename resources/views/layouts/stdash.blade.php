...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="bg-dark">
        <div class="container-fluid">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="controllers col-sm-12 text-center">
                        <a style="width: 150px;" type="butto n" id="st orebu" class="btn btn-primary btn-lg"
                           href="{{route('store.store')}}">Store
                        </a>
                        <a style="width: 150px;" type="butt on" id="sa lesbu" class="btn btn-primary btn-lg"
                           href="{{route('sale.sale')}}">sales
                        </a>
                        <a style="width: 150px;" type="but ton" id="p urchbut" class="btn btn-primary btn-lg"
                           href="{{route('purchases.purchases')}}">
                            Purchases
                        </a> <a style="width: 150px;" type="but ton" id="p urchbut" class="btn btn-primary btn-lg"
                                href="{{route('card.card')}}">
                            Card
                        </a>
                    </div>
                    @yield('content')
    ...
    */
    ...
    function savedata() {
        ...
        db.transaction(function (tx) {
            ...
            tx.executeSql(('INSERT INTO supplier (name,address,mobilenumber,telephonenumber) VALUES (?,?,?,?)'), [
                data.push = document.getElementById('Suppliername').value,
